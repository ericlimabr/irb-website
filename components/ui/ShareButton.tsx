...
type ShareButtonProps = {
  /** URL a compartilhar (fallback SSR; no cliente usa a URL da página). */
  url: string
  title?: string
  text?: string
  /** Rótulo do botão no estado normal. */
  label?: string
  /** Sobrescreve as classes (ex.: cor do texto conforme o fundo claro/escuro). */
  className?: string
}
 ...
 * gerado pelas tags Open Graph da própria URL). Onde não há Web Share (desktops),
 * cai para copiar o link e mostra um "Copiado!" breve.
 */
