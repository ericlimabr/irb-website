...
> - **Métricas na captura:** 15.621 visualizações · 9 comentários · 17 curtidas
>
> Texto transcrito **verbatim**. Os marcadores `[ANO]` eram rótulos visuais de uma
> linha do tempo no layout original. Ao republicar em `/blog`, criar **301** da URL
> antiga → nova (ver `docs/seo-palavras-chave.md`).
...
## [1517] A Grande Reforma Protestante
...
## [1555-1558] As Igrejas Reformadas no Brasil: Primeira Igreja evangélica no País
...
## [1558] A Igreja Reformada da Baía de Guanabara: primeiros mártires brasileiros
...
## [1630-1654] As Igrejas Reformadas do Nordeste: Primeira Igreja Missionária do País
...
## [SÉC XVII E XVIII] As Igrejas Reformadas e a Tradução da Bíblia em Português
...
## [SÉC XIX] As Igrejas Reformadas e a Segunda Vinda da Igreja Evangélica para Brasil
...
## [SÉC XX E XXI] As Igrejas Reformadas no Brasil
