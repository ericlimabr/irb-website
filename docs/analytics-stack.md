...
**8 tags de medição:** GA4 - Configuration (`G-9VGVR21929`), GA4 - `contact_form_submit`,
...
Microsoft Clarity (`y4vr1pvdsk`). Os 4 eventos de CTA são **tags de evento GA4**
próprias (não só triggers).
